 ...
 * 
 */
@WebServiceClient(name = "SmsService", targetNamespace = "http://differitas.no/2006/09/messaging/sms", wsdlLocation = "file:/Users/gwv9478/Desktop/test/telia-smsbulk.wsdl.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/Users/gwv9478/Desktop/test/telia-smsbulk.wsdl.xml");
